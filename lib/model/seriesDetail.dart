class seriesDetail {
  ...
  seriesDetail.fromJson(Map<String, dynamic> json) {
    adult = json['adult'];
    backdropPath = json['backdrop_path'];
    if (json['created_by'] != null) {
      createdBy = <Null>[];
      json['created_by'].forEach((v) {
        // createdBy!.add(new Null.fromJson(v));
      });
    }
    ...
    nextEpisodeToAir = json['next_episode_to_air'] != null
        ? new LastEpisodeToAir.fromJson(json['next_episode_to_air'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.createdBy != null) {
      data['created_by'] = createdBy!.map((v) => v.toString()).toList();
    }
